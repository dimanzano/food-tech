...
function ClickAwayListener(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(React21.Fragment, {
    children: React21.cloneElement(children2, childrenProps)
  });
}
...
var Portal = React23.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React23.isValidElement(children2) ? children2.ref : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    ...
    return (0, import_jsx_runtime19.jsx)(React23.Fragment, {
      children: children2
    });
  }
  return (0, import_jsx_runtime19.jsx)(React23.Fragment, {
...
function ThemeProvider(_ref) {
  ...
  return (0, import_jsx_runtime23.jsx)(ThemeProvider_default, _extends({}, props, {
...
var Badge = React37.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime32.jsxs)(Root, _extends({}, rootProps, {
    children: [children2, (0, import_jsx_runtime31.jsx)(BadgeComponent, _extends({}, badgeProps, {
...
function useButton(parameters = {}) {
  ...
  const [hostElementName, setHostElementName] = React38.useState("");
  ...
  const updateHostElementName = React38.useCallback((instance) => {
...
function Dropdown(props) {
  ...
  return (0, import_jsx_runtime34.jsx)(DropdownContext.Provider, {
    value: contextValue,
    children: children2
  });
}
...
var FormControlContext2 = React44.createContext(void 0);
if (true) {
...
var FormControl = React45.forwardRef(function FormControl2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime35.jsx)(FormControlContext2.Provider, {
    value: childContext,
...
function useFormControlContext() {
  return React46.useContext(FormControlContext2);
}
...
var Input = React48.forwardRef(function Input2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime37.jsxs)(Root, _extends({}, rootProps, {
    children: [startAdornment, (0, import_jsx_runtime36.jsx)(InputComponent, _extends({}, inputProps)), endAdornment]
  }));
});
...
function useListChangeNotifiers() {
  ...
  const notifySelectionChanged = React50.useCallback((newSelectedItems) => {
    messageBus.publish(SELECTION_CHANGE_TOPIC, newSelectedItems);
  }, [messageBus]);
  const notifyHighlightChanged = React50.useCallback((newHighlightedItem) => {
    messageBus.publish(HIGHLIGHT_CHANGE_TOPIC, newHighlightedItem);
  }, [messageBus]);
  const registerSelectionChangeHandler = React50.useCallback((handler) => {
    return messageBus.subscribe(SELECTION_CHANGE_TOPIC, handler);
  }, [messageBus]);
  const registerHighlightChangeHandler = React50.useCallback((handler) => {
...
function useList(params) {
  ...
  const handleHighlightChange = React53.useCallback((event, value, reason) => {
  ...
  const stateComparers = React53.useMemo(() => ({
    highlightedValue: itemComparer,
    selectedValues: (valuesArray1, valuesArray2) => areArraysEqual(valuesArray1, valuesArray2, itemComparer)
  }), [itemComparer]);
  const handleStateChange = React53.useCallback((event, field, value, reason, state2) => {
  ...
  const listActionContext = React53.useMemo(() => {
    return {
      disabledItemsFocusable,
      disableListWrap,
      focusManagement,
  ...
  const actionContext = React53.useMemo(() => _extends({}, reducerActionContext, listActionContext), [reducerActionContext, listActionContext]);
  const [state, dispatch] = useControllableReducer({
    reducer,
    actionContext,
    initialState,
  ...
  const previousItems = React53.useRef([]);
  React53.useEffect(() => {
  ...
  const getItemState = React53.useCallback((item) => {
...
function useForcedRerendering() {
  const [, setState] = React54.useState({});
...
var ListContext = React55.createContext(null);
if (true) {
...
function useListItem(parameters) {
  ...
  const listContext = React56.useContext(ListContext);
  if (!listContext) {
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = (_React$useContext = React58.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT;
  const isInitiallyOpen = React58.useRef(open);
  const {
    subitems,
    contextValue: compoundComponentContextValue
  } = useCompoundParent();
  const subitemKeys = React58.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getItemDomElement = React58.useCallback((itemId) => {
...
var _excluded21 = ["actions", "children", "onItemsChange", "slotProps", "slots"];
...
var Menu = React60.forwardRef(function Menu2(props, forwardedRef) {
  ...
  if (open === true && triggerElement == null) {
    return (0, import_jsx_runtime39.jsx)(Root, _extends({}, rootProps, {
      children: (0, import_jsx_runtime39.jsx)(Listbox, _extends({}, listboxProps, {
        children: (0, import_jsx_runtime39.jsx)(MenuProvider, {
          value: contextValue,
          children: children2
        })
      }))
  ...
  return (0, import_jsx_runtime39.jsx)(Popper, _extends({}, rootProps, {
    open,
...
function useCompoundItem(id, itemMetadata) {
  const context = React63.useContext(CompoundComponentContext);
  if (context === null) {
  ...
  const [registeredId, setRegisteredId] = React63.useState(typeof id === "function" ? void 0 : id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = (_React$useContext = React64.useContext(DropdownContext)) != null ? _React$useContext : FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted,
...
var MenuItem = React65.forwardRef(function MenuItem2(props, forwardedRef) {
  var _slots$root;
  const {
    children: children2,
    disabled: disabledProp = false,
...
var Modal = React67.forwardRef(function Modal2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime42.jsx)(Portal, {
    ...
    children: (0, import_jsx_runtime43.jsxs)(Root, _extends({}, rootProps, {
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime42.jsx)(BackdropComponent, _extends({}, backdropProps)) : null, (0, import_jsx_runtime42.jsx)(FocusTrap, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
function useNumberInput(parameters) {
  ...
  const [dirtyValue, setDirtyValue] = React68.useState(value ? String(value) : void 0);
  React68.useEffect(() => {
...
var NumberInput = React69.forwardRef(function NumberInput2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime45.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime44.jsx)(DecrementButton, _extends({}, decrementButtonProps)), (0, import_jsx_runtime44.jsx)(IncrementButton, _extends({}, incrementButtonProps)), startAdornment, (0, import_jsx_runtime44.jsx)(Input3, _extends({}, inputProps)), endAdornment]
  }));
});
...
var OptionGroup = React70.forwardRef(function OptionGroup2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime47.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime46.jsx)(Label, _extends({}, labelProps, {
      children: props.label
    })), (0, import_jsx_runtime46.jsx)(List, _extends({}, listProps, {
...
var Option = React72.memo(React72.forwardRef(function Option2(props, forwardedRef) {
...
function useLatestRef(value) {
  const ref = React73.useRef(value);
  index(() => {
    ref.current = value;
  });
  return ref;
...
function useFloating(options) {
  ...
  const [data, setData] = React73.useState({
    x: 0,
    y: 0,
    strategy,
    placement,
  ...
  const [latestMiddleware, setLatestMiddleware] = React73.useState(middleware);
  if (!deepEqual(latestMiddleware, middleware)) {
    setLatestMiddleware(middleware);
  }
  const [_reference, _setReference] = React73.useState(null);
  const [_floating, _setFloating] = React73.useState(null);
  const setReference = React73.useCallback((node) => {
    if (node != referenceRef.current) {
      referenceRef.current = node;
      _setReference(node);
    }
  }, [_setReference]);
  const setFloating = React73.useCallback((node) => {
  ...
  const referenceRef = React73.useRef(null);
  const floatingRef = React73.useRef(null);
  const dataRef = React73.useRef(data);
  ...
  const isMountedRef = React73.useRef(false);
  index(() => {
  ...
  const refs = React73.useMemo(() => ({
    reference: referenceRef,
    floating: floatingRef,
    setReference,
    setFloating
  }), [setReference, setFloating]);
  const elements = React73.useMemo(() => ({
    reference: referenceEl,
    floating: floatingEl
  }), [referenceEl, floatingEl]);
  const floatingStyles = React73.useMemo(() => {
    const initialStyles = {
      position: strategy,
      left: 0,
      top: 0
...
var _excluded31 = ["anchor", "children", "container", "disablePortal", "keepMounted", "middleware", "offset", "open", "placement", "slotProps", "slots", "strategy", "withTransition"];
...
var Popup = React74.forwardRef(function Popup2(props, forwardedRef) {
  var _slots$root;
  const {
    anchor: anchorProp,
    children: children2,
...
var _span;
var _excluded32 = ["areOptionsEqual", "autoFocus", "children", "defaultValue", "defaultListboxOpen", "disabled", "getSerializedValue", "listboxId", "listboxOpen", "multiple", "name", "required", "onChange", "onListboxOpenChange", "getOptionAsString", "renderValue", "placeholder", "slotProps", "slots", "value"];
function defaultRenderValue(selectedOptions) {
  var _selectedOptions$labe;
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime51.jsx)(React77.Fragment, {
...
var Select = React77.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime52.jsxs)(React77.Fragment, {
    children: [(0, import_jsx_runtime51.jsx)(Button5, _extends({}, buttonProps, {
    ...
    })), buttonDefined && (0, import_jsx_runtime51.jsx)(PopperComponent, _extends({}, popperProps, {
      children: (0, import_jsx_runtime51.jsx)(ListboxRoot, _extends({}, listboxProps, {
        children: (0, import_jsx_runtime51.jsx)(SelectProvider, {
          value: contextValue,
          children: children2
        })
      }))
    })), (0, import_jsx_runtime51.jsx)("input", _extends({}, getHiddenInputProps()))]
  });
});
...
var _excluded33 = ["aria-label", "aria-valuetext", "aria-labelledby", "className", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "orientation", "scale", "step", "tabIndex", "track", "value", "valueLabelFormat", "isRtl", "defaultValue", "slotProps", "slots"];
...
var Slider = React79.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime54.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime53.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime53.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min3 && mark.value <= max3).map((mark, index2) => {
      ...
      return (0, import_jsx_runtime54.jsxs)(React79.Fragment, {
        children: [(0, import_jsx_runtime53.jsx)(Mark, _extends({
          "data-index": index2
        ...
        })), mark.label != null ? (0, import_jsx_runtime53.jsx)(MarkLabel, _extends({
          "aria-hidden": true,
          "data-index": index2
      ...
      return (0, import_jsx_runtime54.jsxs)(Thumb, _extends({
        "data-index": index2
        ...
        }, inputProps)), ValueLabel ? (0, import_jsx_runtime53.jsx)(ValueLabel, _extends({}, !isHostComponent(ValueLabel) && {
          valueLabelFormat,
          index: index2,
          disabled
        }, valueLabelProps, {
...
var Snackbar = React81.forwardRef(function Snackbar2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime55.jsx)(ClickAwayListener, _extends({}, clickAwayListenerProps, {
    children: (0, import_jsx_runtime55.jsx)(Root, _extends({}, rootProps, {
      children: children2
    }))
  }));
});
...
var Switch = React83.forwardRef(function Switch2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime57.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime56.jsx)(Track, _extends({}, trackProps)), (0, import_jsx_runtime56.jsx)(Thumb, _extends({}, thumbProps)), (0, import_jsx_runtime56.jsx)(Input3, _extends({}, inputProps))]
  }));
});
...
function LastPageIconDefault() {
  return _span2 || (_span2 = (0, import_jsx_runtime58.jsx)("span", {
    children: "⇾|"
  }));
}
function FirstPageIconDefault() {
  return _span22 || (_span22 = (0, import_jsx_runtime58.jsx)("span", {
    children: "|⇽"
  }));
}
function NextPageIconDefault() {
  return _span3 || (_span3 = (0, import_jsx_runtime58.jsx)("span", {
    children: "⇾"
  }));
}
function BackPageIconDefault() {
  return _span4 || (_span4 = (0, import_jsx_runtime58.jsx)("span", {
    children: "⇽"
  }));
}
...
var TablePaginationActions = React84.forwardRef(function TablePaginationActions2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime59.jsxs)(Root, _extends({}, rootProps, {
    children: [showFirstButton && (0, import_jsx_runtime58.jsx)(FirstButton, _extends({}, firstButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime58.jsx)(LastPageIcon, {}) : (0, import_jsx_runtime58.jsx)(FirstPageIcon, {})
    })), (0, import_jsx_runtime58.jsx)(BackButton, _extends({}, backButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime58.jsx)(NextPageIcon, {}) : (0, import_jsx_runtime58.jsx)(BackPageIcon, {})
    })), (0, import_jsx_runtime58.jsx)(NextButton, _extends({}, nextButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime58.jsx)(BackPageIcon, {}) : (0, import_jsx_runtime58.jsx)(NextPageIcon, {})
    })), showLastButton && (0, import_jsx_runtime58.jsx)(LastButton, _extends({}, lastButtonProps, {
      children: direction === "rtl" ? (0, import_jsx_runtime58.jsx)(FirstPageIcon, {}) : (0, import_jsx_runtime58.jsx)(LastPageIcon, {})
    }))]
  }));
});
...
var TablePagination = React85.forwardRef(function TablePagination2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime60.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime61.jsxs)(Toolbar, _extends({}, toolbarProps, {
      children: [(0, import_jsx_runtime60.jsx)(Spacer, _extends({}, spacerProps)), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime60.jsx)(SelectLabel, _extends({}, selectLabelProps, {
        children: labelRowsPerPage
      })), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime60.jsx)(Select3, _extends({}, selectProps, {
      ...
      })), (0, import_jsx_runtime60.jsx)(DisplayedRows, _extends({}, displayedRowsProps, {
      ...
      })), (0, import_jsx_runtime60.jsx)(Actions, _extends({}, actionsProps))]
    }))
  }));
});
...
function TabsProvider(props) {
  ...
  return (0, import_jsx_runtime62.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime62.jsx)(TabsContext.Provider, {
...
var _excluded38 = ["children", "value", "defaultValue", "orientation", "direction", "onChange", "selectionFollowsFocus", "slotProps", "slots"];
...
var Tabs = React89.forwardRef(function Tabs2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime63.jsx)(TabsRoot2, _extends({}, tabsRootProps, {
    children: (0, import_jsx_runtime63.jsx)(TabsProvider, {
      value: contextValue,
      children: children2
    })
  }));
...
var _excluded39 = ["children", "value", "slotProps", "slots"];
...
var TabPanel = React91.forwardRef(function TabPanel2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime64.jsx)(TabPanelRoot, _extends({}, tabPanelRootProps, {
...
function TabsListProvider(props) {
  ...
  return (0, import_jsx_runtime65.jsx)(CompoundComponentContext.Provider, {
    value: compoundComponentContextValue,
    children: (0, import_jsx_runtime65.jsx)(ListContext.Provider, {
      value: listContextValue,
      children: children2
    })
  });
...
var _excluded40 = ["children", "slotProps", "slots"];
...
var TabsList = React94.forwardRef(function TabsList2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime66.jsx)(TabsListProvider, {
    value: contextValue,
    children: (0, import_jsx_runtime66.jsx)(TabsListRoot, _extends({}, tabsListRootProps, {
      children: children2
    }))
  });
});
...
var _excluded41 = ["action", "children", "value", "disabled", "onChange", "onClick", "onFocus", "slotProps", "slots"];
...
var Tab = React96.forwardRef(function Tab2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime67.jsx)(TabRoot, _extends({}, tabRootProps, {
    children: children2
  }));
});
true ? Tab.propTypes = {
...
var inputGlobalStyles = (0, import_jsx_runtime68.jsx)(GlobalStyles_default, {
  styles: {
...
var InputBase = React97.forwardRef(function InputBase2(inProps, ref) {
  ...
  const inputRef = React97.useRef();
  const handleInputRefWarning = React97.useCallback((instance) => {
    if (true) {
      if (instance && instance.nodeName !== "INPUT" && !instance.focus) {
  ...
  const checkDirty = React97.useCallback((obj) => {
    if (isFilled(obj)) {
      if (onFilled) {
        onFilled();
      }
  ...
  return (0, import_jsx_runtime69.jsxs)(React97.Fragment, {
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, (0, import_jsx_runtime69.jsxs)(Root, _extends({}, rootProps, !isHostComponent(Root) && {
      ...
      children: [startAdornment, (0, import_jsx_runtime68.jsx)(FormControlContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime68.jsx)(Input3, _extends({
          ownerState,
...
true ? InputBase.propTypes = {
   ...
   * @default false
   */
  disableInjectingGlobalStyles: import_prop_types47.default.bool,
  /**
   ...
   */
  onInvalid: import_prop_types47.default.func,
  /**
   * @ignore
   */
...
var Autocomplete = React99.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  const {
    ...
    ChipProps,
    className,
    clearIcon = _ClearIcon || (_ClearIcon = (0, import_jsx_runtime71.jsx)(Close_default, {
      fontSize: "small"
    })),
    clearOnBlur = !props.freeSolo,
    clearOnEscape = false,
    ...
    popupIcon = _ArrowDropDownIcon || (_ArrowDropDownIcon = (0, import_jsx_runtime71.jsx)(ArrowDropDown_default, {})),
    readOnly = false,
  ...
  if (multiple && value.length > 0) {
    ...
    if (renderTags) {
      ...
      startAdornment = value.map((option, index2) => (0, import_jsx_runtime71.jsx)(Chip_default, _extends({
  ...
  if (limitTags > -1 && Array.isArray(startAdornment)) {
    ...
    if (!focused && more > 0) {
      ...
      startAdornment.push((0, import_jsx_runtime71.jsx)("span", {
        className: classes.tag,
        children: getLimitTagsText(more)
      }, startAdornment.length));
    }
  }
  const defaultRenderGroup = (params) => (0, import_jsx_runtime72.jsxs)("li", {
    children: [(0, import_jsx_runtime71.jsx)(AutocompleteGroupLabel, {
      className: classes.groupLabel,
      ownerState,
      component: "div",
      children: params.group
    }), (0, import_jsx_runtime71.jsx)(AutocompleteGroupUl, {
  ...
  const defaultRenderOption = (props2, option) => (0, import_jsx_runtime71.jsx)("li", _extends({}, props2, {
  ...
  return (0, import_jsx_runtime72.jsxs)(React99.Fragment, {
    children: [(0, import_jsx_runtime71.jsx)(AutocompleteRoot, _extends({
      ref,
      className: clsx_default(classes.root, className),
      ownerState
    }, getRootProps(other), {
      children: renderInput({
        ...
        InputProps: _extends({
          ...
          endAdornment: (0, import_jsx_runtime72.jsxs)(AutocompleteEndAdornment, {
            className: classes.endAdornment,
            ownerState,
            children: [hasClearIcon ? (0, import_jsx_runtime71.jsx)(AutocompleteClearIndicator, _extends({}, getClearProps(), {
              ...
              children: clearIcon
            })) : null, hasPopupIcon ? (0, import_jsx_runtime71.jsx)(AutocompletePopupIndicator, _extends({}, getPopupIndicatorProps(), {
              disabled,
    ...
    })), anchorEl ? (0, import_jsx_runtime71.jsx)(AutocompletePopper, _extends({
      as: PopperComponent,
      disablePortal,
      style: {
      ...
      children: (0, import_jsx_runtime72.jsxs)(AutocompletePaper, _extends({
        ownerState,
        as: PaperComponent
      }, paperSlotProps, {
        className: clsx_default(classes.paper, paperSlotProps == null ? void 0 : paperSlotProps.className),
        children: [loading && groupedOptions.length === 0 ? (0, import_jsx_runtime71.jsx)(AutocompleteLoading, {
          className: classes.loading,
          ownerState,
          children: loadingText
        }) : null, groupedOptions.length === 0 && !freeSolo && !loading ? (0, import_jsx_runtime71.jsx)(AutocompleteNoOptions, {
        ...
        }) : null, groupedOptions.length > 0 ? (0, import_jsx_runtime71.jsx)(AutocompleteListbox, _extends({
          as: ListboxComponent,
          className: classes.listbox,
          ownerState
...
true ? Autocomplete.propTypes = {
   ...
   * @default false
   */
  autoComplete: import_prop_types48.default.bool,
  /**
   * If `true`, the first option is automatically highlighted.
   * @default false
   */
  autoHighlight: import_prop_types48.default.bool,
  /**
   ...
   * @default false
   */
  autoSelect: import_prop_types48.default.bool,
  /**
   ...
   * @default false
   */
  blurOnSelect: import_prop_types48.default.oneOfType([import_prop_types48.default.oneOf(["mouse", "touch"]), import_prop_types48.default.bool]),
  /**
   * Props applied to the [`Chip`](/material-ui/api/chip/) element.
   */
  ChipProps: import_prop_types48.default.object,
  /**
   * Override or extend the styles applied to the component.
   */
   ...
   */
  clearIcon: import_prop_types48.default.node,
  /**
   ...
   */
  clearOnBlur: import_prop_types48.default.bool,
  /**
   * If `true`, clear all values when the user presses escape and the popup is closed.
   * @default false
   */
  clearOnEscape: import_prop_types48.default.bool,
  /**
   ...
   * @default 'Clear'
   */
  clearText: import_prop_types48.default.string,
  /**
  ...
  componentsProps: import_prop_types48.default.shape({
    clearIndicator: import_prop_types48.default.object,
    paper: import_prop_types48.default.object,
    popper: import_prop_types48.default.object,
    popupIndicator: import_prop_types48.default.object
  }),
  /**
   * The default value. Use when the component is not controlled.
   * @default props.multiple ? [] : null
   */
  defaultValue: chainPropTypes(import_prop_types48.default.any, (props) => {
   ...
   * @default false
   */
  disableClearable: import_prop_types48.default.bool,
  /**
   ...
   * @returns {Value[]}
   */
  filterOptions: import_prop_types48.default.func,
  /**
   * If `true`, hide the selected options from the list box.
   * @default false
   */
  filterSelectedOptions: import_prop_types48.default.bool,
  /**
   * Force the visibility display of the popup icon.
   * @default 'auto'
   */
  forcePopupIcon: import_prop_types48.default.oneOfType([import_prop_types48.default.oneOf(["auto"]), import_prop_types48.default.bool]),
  /**
   * If `true`, the Autocomplete is free solo, meaning that the user input is not bound to provided options.
   * @default false
   */
  freeSolo: import_prop_types48.default.bool,
  /**
   * If `true`, the input will take up the full width of its container.
   * @default false
   */
   ...
   * @default (more) => `+${more}`
   */
  getLimitTagsText: import_prop_types48.default.func,
  /**
   ...
   * @returns {boolean}
   */
  getOptionDisabled: import_prop_types48.default.func,
  /**
   ...
   * @returns {string}
   */
  groupBy: import_prop_types48.default.func,
  /**
   * If `true`, the component handles the "Home" and "End" keys when the popup is open.
   * It should move focus to the first option and last option, respectively.
   * @default !props.freeSolo
   */
  handleHomeEndKeys: import_prop_types48.default.bool,
  /**
   ...
   * @default false
   */
  includeInputInList: import_prop_types48.default.bool,
  /**
   * The input value.
   */
  inputValue: import_prop_types48.default.string,
  /**
   ...
   * @returns {boolean}
   */
  isOptionEqualToValue: import_prop_types48.default.func,
  /**
   ...
   * @default 'ul'
   */
  ListboxComponent: import_prop_types48.default.elementType,
  /**
   * Props applied to the Listbox element.
   */
  ListboxProps: import_prop_types48.default.object,
  /**
   ...
   * @default 'Loading…'
   */
  loadingText: import_prop_types48.default.node,
  /**
   ...
   * @default 'No options'
   */
  noOptionsText: import_prop_types48.default.node,
  /**
   ...
   */
  onInputChange: import_prop_types48.default.func,
  /**
   ...
   * @default false
   */
  openOnFocus: import_prop_types48.default.bool,
  /**
   ...
   * @default 'Open'
   */
  openText: import_prop_types48.default.string,
  /**
   * Array of options.
   */
  options: import_prop_types48.default.array.isRequired,
  /**
   ...
   */
  popupIcon: import_prop_types48.default.node,
  /**
   ...
   * @returns {ReactNode}
   */
  renderGroup: import_prop_types48.default.func,
  /**
   * Render the input.
   *
   * @param {object} params
   ...
   * @returns {ReactNode}
   */
  renderOption: import_prop_types48.default.func,
  /**
   ...
   * @returns {ReactNode}
   */
  renderTags: import_prop_types48.default.func,
  /**
   * If `true`, the input's text is selected on focus.
   * It helps the user clear the selected value.
   * @default !props.freeSolo
   */
  selectOnFocus: import_prop_types48.default.bool,
  /**
   * The size of the component.
   * @default 'medium'
   */
   ...
   */
  value: chainPropTypes(import_prop_types48.default.any, (props) => {
...
var Person_default = createSvgIcon((0, import_jsx_runtime73.jsx)("path", {
  d: "M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z"
}), "Person");

// node_modules/.pnpm/@mui+material@5.14.12_@emotion+react@11.11.1_@emotion+styled@11.11.0_@types+react@18.2.24_react-dom@18.2.0_react@18.2.0/node_modules/@mui/material/Avatar/Avatar.js
var import_jsx_runtime74 = __toESM(require_jsx_runtime());
var _excluded44 = ["alt", "children", "className", "component", "imgProps", "sizes", "src", "srcSet", "variant"];
...
function useLoaded({
  ...
  const [loaded, setLoaded] = React101.useState(false);
  React101.useEffect(() => {
    if (!src && !srcSet) {
      return void 0;
    }
...
var Avatar = React101.forwardRef(function Avatar2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiAvatar"
  });
  ...
  if (hasImgNotFailing) {
    children2 = (0, import_jsx_runtime74.jsx)(AvatarImg, _extends({
      alt,
      srcSet,
      src,
      sizes,
    ...
    children2 = (0, import_jsx_runtime74.jsx)(AvatarFallback, {
      ownerState,
      className: classes.fallback
    });
  }
  return (0, import_jsx_runtime74.jsx)(AvatarRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
...
true ? Avatar.propTypes = {
   ...
   */
  alt: import_prop_types49.default.string,
  /**
   ...
   */
  imgProps: import_prop_types49.default.object,
  /**
   * The `sizes` attribute for the `img` element.
   */
  sizes: import_prop_types49.default.string,
  /**
   * The `src` attribute for the `img` element.
   */
  src: import_prop_types49.default.string,
  /**
   * The `srcSet` attribute for the `img` element.
   * Use this attribute for responsive image display.
   */
  srcSet: import_prop_types49.default.string,
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   * @default 'circular'
   */
  variant: import_prop_types49.default.oneOfType([import_prop_types49.default.oneOf(["circular", "rounded", "square"]), import_prop_types49.default.string])
} : void 0;
...
var _excluded45 = ["children", "className", "component", "componentsProps", "max", "slotProps", "spacing", "total", "variant"];
var SPACINGS = {
  small: -16,
  medium: null
};
...
var AvatarGroup = React102.forwardRef(function AvatarGroup2(inProps, ref) {
  ...
  const children2 = React102.Children.toArray(childrenProp).filter((child) => {
    if (true) {
  ...
  return (0, import_jsx_runtime75.jsxs)(AvatarGroupRoot, _extends({
    as: component,
    ownerState,
    className: clsx_default(classes.root, className),
    ref
  }, other, {
    children: [extraAvatars ? (0, import_jsx_runtime75.jsxs)(AvatarGroupAvatar, _extends({
      ownerState,
      variant
...
true ? AvatarGroup.propTypes = {
  ...
  componentsProps: import_prop_types50.default.shape({
    additionalAvatar: import_prop_types50.default.object
  }),
  /**
   * Max avatars to show before +x.
   * @default 5
   */
  max: chainPropTypes(import_prop_types50.default.number, (props) => {
    if (props.max < 2) {
   ...
   * @default 'medium'
   */
  spacing: import_prop_types50.default.oneOfType([import_prop_types50.default.oneOf(["medium", "small"]), import_prop_types50.default.number]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
   ...
   */
  total: import_prop_types50.default.number,
  /**
   * The variant to use.
   * @default 'circular'
   */
...
var ButtonGroupContext = React103.createContext({});
if (true) {
...
var ButtonGroupButtonContext = React104.createContext(void 0);
if (true) {
...
var _excluded46 = ["children", "color", "component", "className", "disabled", "disableElevation", "disableFocusRipple", "endIcon", "focusVisibleClassName", "fullWidth", "size", "startIcon", "type", "variant"];
...
var Button3 = React105.forwardRef(function Button4(inProps, ref) {
  const contextProps = React105.useContext(ButtonGroupContext_default);
  const buttonGroupButtonContextPositionClassName = React105.useContext(ButtonGroupButtonContext_default);
  ...
  const startIcon = startIconProp && (0, import_jsx_runtime76.jsx)(ButtonStartIcon, {
    className: classes.startIcon,
    ownerState,
    children: startIconProp
  });
  const endIcon = endIconProp && (0, import_jsx_runtime76.jsx)(ButtonEndIcon, {
    className: classes.endIcon,
    ownerState,
    children: endIconProp
  });
  const positionClassName = buttonGroupButtonContextPositionClassName || "";
  return (0, import_jsx_runtime77.jsxs)(ButtonRoot, _extends({
    ownerState,
...
var CircularProgress = React106.forwardRef(function CircularProgress2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiCircularProgress"
  });
...
var PaginationItem = React111.forwardRef(function PaginationItem2(inProps, ref) {
  ...
  return type === "start-ellipsis" || type === "end-ellipsis" ? (0, import_jsx_runtime83.jsx)(PaginationItemEllipsis, {
    ...
    children: [type === "page" && page, Icon ? (0, import_jsx_runtime83.jsx)(PaginationItemPageIcon, {
      as: Icon,
      ownerState,
      className: classes.icon
    }) : null]
...
function RatingItem(props) {
  ...
  return (0, import_jsx_runtime89.jsxs)(React115.Fragment, {
...
var defaultIcon = (0, import_jsx_runtime88.jsx)(Star_default, {
  fontSize: "inherit"
});
...
var Zoom = React117.forwardRef(function Zoom2(props, ref) {
  ...
  return (0, import_jsx_runtime91.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => {
      return React117.cloneElement(children2, _extends({
        style: _extends({
          transform: "scale(0)",
...
var _excluded54 = ["children", "className", "color", "component", "disabled", "disableFocusRipple", "focusVisibleClassName", "size", "variant"];
...
var Fab = React118.forwardRef(function Fab2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiFab"
  });
  ...
  return (0, import_jsx_runtime92.jsx)(FabRoot, _extends({
    className: clsx_default(classes.root, className),
    component,
    disabled,
    focusRipple: !disableFocusRipple,
...
var Grow = React120.forwardRef(function Grow2(props, ref) {
  const {
    addEndListener,
    appear = true,
    children: children2,
  ...
  const timer = React120.useRef();
  const autoTimeout = React120.useRef();
  const theme = useTheme();
...
var Tooltip = React121.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children2 = React121.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime96.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme();
  ...
  return (0, import_jsx_runtime97.jsxs)(React121.Fragment, {
    children: [React121.cloneElement(children2, childrenProps), (0, import_jsx_runtime96.jsx)(PopperComponent, _extends({
      ...
      children: ({
        ...
        children: (0, import_jsx_runtime97.jsxs)(TooltipComponent, _extends({}, tooltipProps, {
          children: [title, arrow3 ? (0, import_jsx_runtime96.jsx)(ArrowComponent, _extends({}, tooltipArrowProps, {
            ref: setArrowRef
          })) : null]
        }))
      }))
...
var SpeedDialAction = React122.forwardRef(function SpeedDialAction2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSpeedDialAction"
  });
  ...
  const [tooltipOpen, setTooltipOpen] = React122.useState(tooltipOpenProp);
...
var SpeedDialIcon = React124.forwardRef(function SpeedDialIcon2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiSpeedDialIcon"
  });
  ...
  function formatIcon(icon, newClassName) {
    if (React124.isValidElement(icon)) {
      return React124.cloneElement(icon, {
...
var ToggleButtonGroup = React131.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime110.jsx)(ToggleButtonGroupRoot, _extends({
    ...
    children: React131.Children.map(children2, (child) => {
...
var _excluded65 = ["addEndListener", "children", "className", "collapsedSize", "component", "easing", "in", "onEnter", "onEntered", "onEntering", "onExit", "onExited", "onExiting", "orientation", "style", "timeout", "TransitionComponent"];
...
var Collapse = React132.forwardRef(function Collapse2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiCollapse"
  });
  ...
  const theme = useTheme();
  const timer = React132.useRef();
  const wrapperRef = React132.useRef(null);
  const autoTransitionDuration = React132.useRef();
  ...
  return (0, import_jsx_runtime111.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => (0, import_jsx_runtime111.jsx)(CollapseRoot, _extends({
      as: component,
      className: clsx_default(classes.root, className, {
      ...
      children: (0, import_jsx_runtime111.jsx)(CollapseWrapper, {
        ownerState: _extends({}, ownerState, {
          state
        }),
        className: classes.wrapper,
        ref: wrapperRef,
        children: (0, import_jsx_runtime111.jsx)(CollapseWrapperInner, {
          ownerState: _extends({}, ownerState, {
            state
          }),
...
true ? Collapse.propTypes = {
   ...
   * @default '0px'
   */
  collapsedSize: import_prop_types69.default.oneOfType([import_prop_types69.default.number, import_prop_types69.default.string]),
  /**
   * The component used for the root node.
   * Either a string to use a HTML element or a component.
   */
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-WJVTV4G2.js.map
